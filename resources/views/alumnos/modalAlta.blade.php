                            ...
                            <div class="accordion-body">
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">¿Cuenta con certificado incompleto?</label>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm mb-0" style="font-size: 0.84rem; border-color: #e2e8f0;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-muted w-25 px-3 py-2">CCT Administrativo (SEP):</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-3 py-2"><strong id="sumAsistePresencialTexto" class="text-dark">Regular</strong></td>
