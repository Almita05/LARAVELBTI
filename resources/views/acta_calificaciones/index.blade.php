        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-md-3">
                <a href="{{ route('actas_calificacionesBGNES') }}">
                    <div class="portal-card">
                        <img src="{{ asset('img/SAB.png') }}" alt="Actas de calificaciones-Sábados"
            ...
            <div class="col-md-3">
                <a href="{{ route('actas_calificacionesBGNED') }}">
                    <div class="portal-card">
                        <img src="{{ asset('img/DOM.png') }}" alt="Actas de calificaciones-Domingos"
                            style="width: 100%; max-width: 100px; height: auto;">
                        <br>
            ...
            <div class="col-md-3">
                <a href="{{ route('actas_calificacionesBTI') }}">
                    <div class="portal-card">
                        <img src="{{ asset('img/L_V.png') }}" alt="Actas de calificaciones-Escolarizado"
                            style="width: 100%; max-width: 100px; height: auto;">
                        <br>
