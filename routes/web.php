...
//Route::get('/test-google', [TestController::class, 'index']);

//Route::get('/test-user', [AuthController::class, 'test']);
...
Route::get('/planesBTI', [PlanEstudioController::class, 'bti'])
    ->name('planesBTI');

Route::get('/planesBGNE', [PlanEstudioController::class, 'bgne'])
    ->name('planesBGNE');
...
Route::get('/actas_calificaciones', [ActasCalificacionesController::class, 'index'])
    ->name('actas_calificaciones');


Route::get('/actas_calificacionesBTI', [ActasCalificacionesController::class, 'bti'])
    ->name('actas_calificacionesBTI');


Route::get('/actas_calificacionesBGNES', [ActasCalificacionesController::class, 'bgneS'])
    ->name('actas_calificacionesBGNES');


Route::get('/actas_calificacionesBGNED', [ActasCalificacionesController::class, 'bgneD'])
    ->name('actas_calificacionesBGNED');
...
Route::get('/listas_asistencias', [ListasAsistenciasController::class, 'index'])
    ->name('listas_asistencias');


Route::get('/listas_asistenciasBTI', [ListasAsistenciasController::class, 'bti'])
    ->name('listas_asistenciasBTI');


Route::get('/listas_asistenciasBGNES', [ListasAsistenciasController::class, 'bgneS'])
    ->name('listas_asistenciasBGNES');


Route::get('/listas_asistenciasBGNED', [ListasAsistenciasController::class, 'bgneD'])
    ->name('listas_asistenciasBGNED');
